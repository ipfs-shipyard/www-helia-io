    ...
    return (
      <div className={ navBarClasses } >
        <div className={ styles.navBarMenu }>
          ...
          <Link href="https://proto.school/course/ipfs">
            { messages.navBar.item2 }
          </Link>
          <Link href="https://ipfs.github.io/helia">
            { messages.navBar.item3 }
          </Link>
          <Link href="https://github.com/ipfs/helia">
            { messages.navBar.item4 }
          </Link>
          <div className={ styles.starContainer }>
            <iframe title="desktop-github-stars" src="https://ghbtns.com/github-btn.html?user=ipfs&repo=helia&type=star&count=true" frameBorder="0" scrolling="0" sandbox="allow-scripts" />
          </div>
        </div>
      </div>
    )
