...
import LocalesDropdown from '../../locales-dropdown/index.jsx'
    ...
    return (
      <div className={ styles.container }>
        ...
        <ul className={ styles.menuList } ref={ this.handleMenuListRef } style={ { maxHeight: menuListHeight } } >
          ...
          <li><Link className={ styles.menuLink } href="https://ipfs.github.io/helia"> { messages.navBar.item3 } </Link> </li>
          <li className={ styles.githubContributers }>
            <Link className={ styles.menuLink } href="https://github.com/ipfs/helia"> { messages.navBar.item4 } </Link>
            <iframe title="mobile-github-stars" src="https://ghbtns.com/github-btn.html?user=ipfs&repo=helia&type=star&count=true" frameBorder="0" scrolling="0" sandbox="allow-scripts" />
          </li>
        </ul>
      </div>
    )
